...
t2.word_created as dates,t2.service_id as userid,t1.id as id, t2.created_at as dateni,t2.status as stat from 
beneficiaries as t1 inner join recent_request as t2 on t1.id = t2.beneficiary_id and t2.assistance_recieved ="Technical Assistance" ';
...
{
	$query .= 'group by t2.created_at ORDER BY '.$_POST['order']['0']['column'].' '.$_POST['order']['0']['dir'].' ';
}
else
{
