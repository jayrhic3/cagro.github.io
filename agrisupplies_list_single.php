...
$(document).ready(function(){
    ...
    "order":[],
    "ajax":{
        url:"fetch_agrisupplies_list.php",
        type:"POST"
    },
    "columnDefs":[
        {
    ...
    $(document).on('click','.check',function(){
        ...
        $.ajax({
				url:"goto_single_agrisupplies_list.php",
				method:'POST',
				data:{'user_id':user_id},
				success:function(data)
				{
                    document.location.href="agrisupplies_list_single.php";
				}
			});
    });
    $('#close_button').click(function(){
        document.location.href="planning_agrisupplies.php";
    });
