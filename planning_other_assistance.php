...
$(document).ready(function(){
    ...
    "order":[],
    "ajax":{
        url:"fetch_other_assistance.php",
        type:"POST"
    },
    "columnDefs":[
        {
    ...
    $(document).on('click', '.check', function(){
        ...
        $.ajax({
				url:"goto_single_other_list.php",
				method:'POST',
				data:{'user_id':user_id},
				success:function(data)
				{
                    document.location.href="other_list_single.php";
				}
			});
	});
