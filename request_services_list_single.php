...
<div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
    ...
    <div id="userModal" class="modal fade" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog">
                <form method="post" id="assistance_form" action="print_service_request_single.php" target="_blank">
...
$(document).ready(function(){ 
    ...
    "order":[],
    "ajax":{
        url:"fetch_request_services_single.php",
        type:"POST"
    },
    "columnDefs":[
        {
            ...
            $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        for($i=0;$i<arr1.length;$i++){
                           var html='<p>'+arr1[$i]+'</p>';
                           $('#assistance_form .modal-body').append(html);
                        }
