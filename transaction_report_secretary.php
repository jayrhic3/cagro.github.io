            ...
            <div class="container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h3>Transactional Reports</h3>
                                        <form method="post" action="print_transaction_report.php" target="_blank">
                                            <div class="row">
                                                <div class="col-md-2">
...
$(document).ready(function(){
    ...
    function fetchData(){
        ...
        var id;
        if(name!='All'){
            id=$('#name option:selected').attr('id');
            name='';
        }else{
            id='';
        }
        dataTable = $('#user_data').DataTable({
            ...
            "order":[],
            "ajax":{
                url:"fetch_transactional_report.php",
                type:"POST",
                data:{'status':status,'datefrom':datefrom,'dateto':dateto,'id':id,'name':name}
            },
            "columnDefs":[
                {
                    "targets":[0, 3, 3],
