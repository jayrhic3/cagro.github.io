                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="damage_quantity" id="damage_quantity" class="form-control" required>
                                </div>
                        </div>
                        <div class="modal-footer">
...
$(document).ready(function(){ 
   ...
   function fetchData(){
        ...
        dataTable = $('#user_data').DataTable({
            ...
            "order":[],
            "ajax":{
                url:"fetch_inventory_cornSeeds.php",
                type:"POST",
   ...
   $(document).on('click', '#filter', function(){
       ...
       var quantity=$('#quantity').val()
        ...
        if(product_name!='' && units!='' && quantity!=''){
            ...
            if(filter.test(quantity)){
                $.ajax({
                        url:"insert_product_cornSeeds.php",
                        method:'POST',
    ...
    $(document).on('click', '.check', function(){
		var user_id = $(this).attr("id");
            $.ajax({
                    url:"fetch_single_CornSeeds.php",
                    method:"POST",
