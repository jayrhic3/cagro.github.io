...
$(document).ready(function(){ 
   ...
   function fetchData(){
        ...
        dataTable = $('#user_data').DataTable({
            ...
            "order":[],
            "ajax":{
                url:"fetch_inventory_organic.php",
                type:"POST",
       ...
       var quantity=$('#quantity').val()
        ...
        if(product_name!='' && units!='' && quantity!=''){
            ...
            if(filter.test(quantity)){
                $.ajax({
                        url:"insert_product_organic.php",
                        method:'POST',
