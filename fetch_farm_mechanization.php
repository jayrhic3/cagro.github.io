...
t2.word_created as dates,t2.service_id as id,t1.id as userid, t2.created_at as dateni,t2.status as stat from 
beneficiaries as t1 inner join recent_request as t2 on t1.id = t2.beneficiary_id and t2.assistance_recieved ="Farm Mechanization" ';
