...
$(document).ready(function(){ 
   ...
   function fetchData(){
        ...
        dataTable = $('#user_data').DataTable({
            ...
            "order":[],
            "ajax":{
                url:"fetch_inventory_fruitSeeds.php",
                type:"POST",
