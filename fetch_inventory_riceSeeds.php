...
if($status=='Latest' && $datefrom=='' && $dateto==''){
    ...
    inventory_all_products where type_product="Rice_Seeds" and status_updated="Latest") as t2 ';
    ...
    t2.stat as status,t2.d as id,t2.created as created_at,t2.word_created as dates from (select product_name as prod,units as unit,
    quantity as quan,despensed as despense,status as stat,damage as damage,id as d,created_at as created,word_created as word_created from 
    inventory_all_products where type_product="Rice_Seeds" and status_updated="Old") as t2 ';
    ...
    inventory_all_products where type_product="Rice_Seeds" group by product_name,units) as t2 ';
    ...
    t2.stat as status,t2.d as id,t2.created as created_at,t2.word_created as dates from (select product_name as prod,units as unit,
    quantity as quan,despensed as despense,status as stat,damage as damage,id as d,created_at as created,word_created as word_created from 
    inventory_all_products where type_product="Rice_Seeds" and status_updated="Latest" and DATE_FORMAT(created_at,"%Y-%m-%d") BETWEEN "'.$datefrom.'" AND "'.$dateto.'") as t2 ';
    ...
    inventory_all_products where type_product="Rice_Seeds" and status_updated="Old" and DATE_FORMAT(created_at,"%Y-%m-%d") BETWEEN "'.$datefrom.'" AND "'.$dateto.'") as t2 ';
    ...
    t2.stat as status,t2.d as id,t2.created as created_at from (select product_name as prod,units as unit,
    sum(quantity) as quan,sum(despensed) as despense,sum(damage) as damage,status as stat,id as d,created_at as created from 
    inventory_all_products where type_product="Rice_Seeds" and DATE_FORMAT(created_at,"%Y-%m-%d") BETWEEN "'.$datefrom.'" AND "'.$dateto.'" group by product_name,units) as t2 ';
